...
[TestFixture]
public class WhitelistAttributeTests
{
    [Test]
    public void OnActionExecuting_IpInWhitelist_ShouldRedirect()
    {
        ...
        httpContext.RequestServices = new ServiceCollection()
            ...
            .AddSingleton(whitelistConfigurationMock.Object)
            .BuildServiceProvider();
        var ipWhitelist = new IpWhitelist();
        ipWhitelist.OnActionExecuting(actionExecutingContext);
    ...
    [Test]
    public void OnActionExecuting_IpInWhitelist_ShouldReturn403()
    {
        var inspectorMock = new Mock<IInspector>();
        var whitelistConfigurationMock = new Mock<IWhitelistConfiguration>();
        var httpContext = new DefaultHttpContext();
    ...
    [Test]
    public void OnActionExecuting_IpNotInWhitelist_ShouldNotChangeResult()
    {
        var inspectorMock = new Mock<IInspector>();
        var whitelistConfigurationMock = new Mock<IWhitelistConfiguration>();
        var httpContext = new DefaultHttpContext();
